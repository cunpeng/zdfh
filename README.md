# 卡密转链接文本发货
- 适合某鱼等平台，名创优品、星巴克、肯德基等卡密转链接文本发货形式。
...
## 宝塔面板安装教程
- 新建网站，将文件全部复制到网站任意目录下
- 根据自己的防护配置进行修正代码
- 模式1 index.php?mode=1&content=后面是卡密
- 模式2 index.php?mode=2&content=后面是卡密
...
## 声明 致谢
- 本项目使用的qrcode.php来自phpqrcode-2010100721_1.1.4中phpqrcode.php
